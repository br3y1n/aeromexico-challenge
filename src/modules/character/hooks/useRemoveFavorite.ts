...
const useRemoveFavorite = (repository: CharacterFavoriteRepository) => {
  const queryClient = useQueryClient();

  return useMutation({
    mutationFn: (character: Character) => repository.removeFavorite(character),
    onSuccess: () => {
